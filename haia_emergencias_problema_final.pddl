...
(:objects
          ...
          P1 P2 P3 - pol
          B1 B2 - bom
          V1 V2 V3 V4 V5 V6 V7 V8 V9 V10 V11 V12 - vic
)
...
(:init
	  ...
	  (accidente V11 E1 E2)(accidente V11 E2 E1)
	  (accidente V12 E2 E5)(accidente V12 E5 E2)
...
(:metric minimize (+ (* (total-time) 1) 0))
;(:metric minimize (victim-time))
;(:metric minimize (remove-debris-time))
;(:metric minimize (fire-extinguish-time))
